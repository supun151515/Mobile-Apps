...
var karma_host_resolver_1 = require("./services/karma-host-resolver");
var karma_files_service_1 = require("./services/karma-files-service");
var test_execution_service_1 = require("./services/test-execution-service");
...
var TestBrokerViewModel = (function (_super) {
    ...
    function TestBrokerViewModel() {
        ...
        _this.karmaFilesService = new karma_files_service_1.KarmaFilesService(http, config);
...
require('tns-core-modules/application').onUncaughtError = function (error) {
