...
var IOSApplication = (function () {
    function IOSApplication() {
        this._backgroundColor = majorVersion <= 12 ? UIColor.whiteColor : UIColor.systemBackgroundColor;
    ...
    IOSApplication.prototype.setWindowContent = function (view) {
        ...
        rootView.on(view_1.ios.traitCollectionColorAppearanceChangedEvent, function () {
...
function getViewController(rootView) {
    ...
    if (!(viewController instanceof UIViewController)) {
        viewController = view_1.ios.UILayoutViewController.initWithOwner(new WeakRef(rootView));
...
function setRootViewCssClasses(rootView) {
...
function setRootViewSystemAppearanceCssClass(rootView) {
    if (majorVersion >= 13) {
        var systemAppearanceCssClass = "" + system_classes_1.CLASS_PREFIX + iosApp.systemAppearance;
        system_classes_1.pushToRootViewCssClasses(systemAppearanceCssClass);
