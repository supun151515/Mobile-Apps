...
// -------------------------------------------------------------------------
import { Component, Input, Output, ViewChild, EventEmitter, OnInit, forwardRef } from '@angular/core';
    ...
    providers: [
        {
            ...
            useExisting: forwardRef(() => KsDropDownListComponent),
            multi: true
        }
    ]
})
export class KsDropDownListComponent extends KsDropDownBaseComponent implements OnInit {
    @ViewChild('kendoComponent', { static: true }) public kendoComponent: DropDownListComponent;
