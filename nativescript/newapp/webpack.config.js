...
module.exports = env => {
    ...
    // start kinvey-nativescript-sdk required changes
    env.externals = env.externals || [];
    env.externals.push('nativescript-sqlite-commercial');
    env.externals.push('nativescript-sqlite-encrypted');
    // end kinvey-nativescript-sdk required changes
    ...
    const config = {
        ...
        output: {
            ...
            path: dist,
            sourceMapFilename,
            library: "app891129c464214486a1ee68678886dc66",
        ...
        plugins: [
            ...
            !env.microapp && new CopyWebpackPlugin([
                { from: { glob: "assets/**" } },
                { from: { glob: "fonts/**" } },
                { from: { glob: "**/*.jpg" } },
                { from: { glob: "**/*.png" } }
