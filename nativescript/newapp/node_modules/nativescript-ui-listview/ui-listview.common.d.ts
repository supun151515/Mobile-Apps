...
export declare class RadListView extends viewModule.ContainerView {
    ...
    static itemSelectedBackgroundColorProperty: viewModule.Property<RadListView, viewModule.Color>;
    ...
    private onItemSelectedBackgroundColorPropertyChanged;
