...
function ensureListViewAdapter() {
    ...
    var ListViewAdapter = /** @class */ (function (_super) {
        ...
        ListViewAdapter.prototype.onCreateViewHolder = function (parent, viewType) {
            ...
            owner._toggleSelectionColor(parentView);
        ...
        ListViewAdapter.prototype.onBindViewHolder = function (holder, position) {
            ...
            owner._toggleSelectionColor(internalLoadingArgs.view);
            var args = {
        ...
        var ListViewSelectionChangedListenerImpl = /** @class */ (function (_super) {
            ...
            ListViewSelectionChangedListenerImpl.prototype.onItemIsSelectedChanged = function (position, newValue) {
                ...
                if (!isGroupHeader) {
                    ...
                    listView._toggleSelectionColor(view, currentEventName);
                    var args = {
                        eventName: currentEventName,
                        object: listView,
                        index: originalPosition,
...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype._toggleSelectionColor = function (view, selectedState) {
        if (!view) {
            return;
        }
        var selectedColor = this.itemSelectedBackgroundColor ? this.itemSelectedBackgroundColor : new color_1.Color("#20000000");
        if (parseInt(platform_1.device.sdkVersion) >= 22) {
            view.nativeView.setBackgroundColor(new color_1.Color("white").android);
            androidx.core.view.ViewCompat.setBackgroundTintMode(view.nativeView, android.graphics.PorterDuff.Mode.SRC_OVER);
            androidx.core.view.ViewCompat.setBackgroundTintList(view.nativeView, this._android.makeBackgroundColorStateList(selectedColor.android));
        }
        else {
            // This is a workaround for API lv under 22 because `Tint` is not usable for normal View objects in that level.
            // Once we start supporting above API 21, remove this code and its call from `onItemIsSelectedChanged`
            if (selectedState) {
                switch (selectedState) {
                    case listViewCommonModule.RadListView.itemSelectedEvent:
                        view.backgroundColor = selectedColor;
                        break;
                    case listViewCommonModule.RadListView.itemDeselectedEvent:
                        view.backgroundColor = new color_1.Color("transparent");
                        break;
                    default:
                        console.log("Warning: Cannot set `itemSelectedBackgroundColor` for state:", selectedState);
                        break;
                }
            }
        }
