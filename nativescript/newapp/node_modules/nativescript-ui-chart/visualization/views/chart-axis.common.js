...
var DateTimeContinuousAxis = /** @class */ (function (_super) {
    ...
    DateTimeContinuousAxis.prototype.onMajorStepUnitPropertyChanged = function (oldValue, newValue) {
        this.onMajorStepUnitChanged(oldValue, newValue);
    };
    DateTimeContinuousAxis.prototype.onMajorStepUnitChanged = function (oldValue, newValue) {
    };
    ...
    DateTimeContinuousAxis.majorStepUnitProperty = new view_1.Property({
        name: "majorStepUnit",
        defaultValue: undefined,
        valueChanged: function (target, oldValue, newValue) {
