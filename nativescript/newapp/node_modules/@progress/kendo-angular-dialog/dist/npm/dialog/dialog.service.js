...
var DialogService = /** @class */ (function () {
    ...
    DialogService.prototype.initializeDialog = function (component, factory, container, dialogRef, options) {
        ...
        var result = rxjs_1.merge(apiClose, dialog.instance.close, dialog.instance.action).pipe(operators_1.take(1));
        ...
        if (component && core_1.isDevMode()) {
            ...
            if (component.prototype instanceof dialog_content_base_1.DialogContentBase) { // content component extends DialogContentBase
    ...
    DialogService.prototype.contentFrom = function (content, container, dialogRef) {
        ...
        else if (content && !(content instanceof core_1.TemplateRef)) { // Component
