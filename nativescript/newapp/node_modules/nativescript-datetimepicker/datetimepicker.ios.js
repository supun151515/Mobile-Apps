...
var DateTimePicker = (function (_super) {
    ...
    DateTimePicker._createNativeDialog = function (nativePicker, options, style, callback) {
        ...
        var pickerContainerFrame = CGRectMake(0, pickerContainerFrameTop, pickerViewWidth, pickerViewHeight);
        var pickerContainer = UIView.alloc().initWithFrame(pickerContainerFrame);
        ...
        var messageLabelContainer = messageLabel.superview;
