...
var TKDataFormDelegateImplementation = /** @class */ (function (_super) {
    ...
    TKDataFormDelegateImplementation.prototype.dataFormDidSelectEditorForProperty = function (dataForm, editor, property) {
        ...
        if (entityProperty.editor) {
            entityProperty.editor.notify({ eventName: editable_text_base_1.EditableTextBase.focusEvent, object: entityProperty.editor });
        }
    };
    /**
    ...
    TKDataFormDelegateImplementation.prototype.dataFormDidDeselectEditorForProperty = function (dataForm, editor, property) {
        ...
        this._owner.get().notify(args);
        if (entityProperty.editor) {
            entityProperty.editor.notify({ eventName: editable_text_base_1.EditableTextBase.blurEvent, object: entityProperty.editor });
        }
    };
    /**
    ...
    */
    ...
    TKDataFormDelegateImplementation.prototype.isUsingBooleanEditor = function (property) {
        return property.editorClass === TKDataFormSwitchEditor.class();
    };
    TKDataFormDelegateImplementation.prototype.isUsingNumericEditor = function (property) {
        return property.editorClass === TKDataFormDecimalEditor.class() ||
            property.editorClass === TKDataFormNumberEditor.class() ||
            property.editorClass === TKDataFormStepperEditor.class() ||
            property.editorClass === TKDataFormSliderEditor.class();
    };
    ...
    TKDataFormDelegateImplementation.prototype.convertToTypedValue = function (oldValue, newValue, nativeProperty) {
        ...
        if (typeof oldValue === "number" || this.isUsingNumericEditor(nativeProperty)) {
            return Number(newValue);
        }
        if (typeof oldValue === "boolean" || this.isUsingBooleanEditor(nativeProperty)) {
